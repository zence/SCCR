...
def sequence(genes, *args):
    ...
    for i in range(len(genes)):
        ...
        cur_auc = run_norm_quan_svm.run(temp_genes)
...
print("Normalized Quantile SVM")

with open("../../../data/norm_quan_FeatureCount.tsv", 'r') as in_f:
...
all_genes = [x for x in all_genes if 'her2' not in x and x != 'Sample']
