...
total_her2_expr = pd.read_csv('../results/robust_rf_genes_TPM.tsv.gz', sep='\t')
...
expr_data = total_her2_expr.iloc[:, :-3]
...
total_her2_expr['SVM_classified'] = total_her2_expr.apply(create_miscl_col, misclassied=misclassied_ids, axis=1)

total_her2_expr.to_csv('../results/both_robust_genes_TPM.tsv.gz', sep='\t', index=False, compression='gzip')
