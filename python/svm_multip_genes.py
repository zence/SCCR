...
total_her2_expr = total_her2_expr[['ERBB2', 'FGFR1', 'EGFR', 'IGF1R', 'FGF1', 'EGF', 'IGF1', 'her2_status_by_ihc', 'Sample']]
...
total_her2_expr.to_csv('../results/svm_multip_genes_TPM.tsv.gz', sep='\t', index=False, compression='gzip')
