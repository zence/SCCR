...
total_her2_expr = total_her2_expr[['ERBB2', 'FGFR1', 'EGFR', 'IGF1R', 'FGF', 'EGF', 'IGF', 'her2_status_by_ihc', 'Sample']]
...
total_her2_expr.to_csv('../results/rf_ERBB2_TPM.tsv.gz', sep='\t', index=False, compression='gzip')
